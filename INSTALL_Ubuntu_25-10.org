...
sudo apt install \
    ...
    `# Utilitaires` curl git gparted htop localepurge plocate sqlite3 unison \
    ...
    `# Utilitaires web` cifs-utils dnsutils gocryptfs gvncviewer network-manager-openconnect-gnome network-manager-openvpn-gnome network-manager-vpnc-gnome openfortivpn network-manager-fortisslvpn-gnome screen \
